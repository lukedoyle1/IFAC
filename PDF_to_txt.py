...
# Define function for converting pdf to text 
...
# Define Function for iterating over directory 
...
output_dir = r"C:\Users\LukeDoyle\OneDrive - Irish Fiscal Advisory Council\Project\SPU\txt"  
